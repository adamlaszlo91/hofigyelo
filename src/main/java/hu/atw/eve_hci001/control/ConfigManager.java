...
/**
 * Beállításokat tároló és konfigurációs fájlt kezelõ osztály.
 * 
 * @author Ádám László
 * 
 */
...
public class ConfigManager {
	...
	public ConfigManager(String configFilePath) {
		...
		/*
		 * alapértelmezett inicializálás, hóval kapcsolatos idõjárás események
		 * figyelésére
		 */
		this.watchedTypes.put("derült", false);
		this.watchedTypes.put("gyengén felhõs", false);
		this.watchedTypes.put("közepesen felhõs", false);
		this.watchedTypes.put("erõsen felhõs", false);
		this.watchedTypes.put("borult", false);
		this.watchedTypes.put("szitálás", false);
		this.watchedTypes.put("gyenge esõ", false);
		this.watchedTypes.put("esõ", false);
		this.watchedTypes.put("ónos esõ", false);
		this.watchedTypes.put("záporesõ", false);
		this.watchedTypes.put("havasesõ", true);
	...
	/**
	 * 
	 * @return Elérhetõ-e a konfigurációs fájl.
	 */
	...
	/**
	 * Ellenõrzi, hogy egy adott idõjárási állaptot figyel-e a felhasználó.
	 * 
	 * @param type
	 *            Az idõjárási állapot.
	 * @return True, ha figyelt, False, ha nem és null, ha ismeretlen idõjárási
	 *         viszony.
	 */
	 ...
	 * elérhetõként lett megállapítva az osztály létrehozásakor, nem csinál
	 * semmit.
	 */
	 ...
	 * elérhetõségét igazra állítja. Ha elõzetesen nem elérhetõként lett
	...
	/**
	 * Visszaad egy kép erõsoffrás fájlt Image objektumként.
	 * 
